...
parser.add_argument("--port", help="WSGIServer Port ID", type=int, default=5003)
...
model = create_model()
#print(model.summary())
model.load_weights(os.path.join(MODEL_SAVE_PATH,"model"+str(1)+".h5")) # Loading best model.
